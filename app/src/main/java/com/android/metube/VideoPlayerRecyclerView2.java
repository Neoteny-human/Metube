...
public class VideoPlayerRecyclerView2 extends RecyclerView {
    ...
    public VideoPlayerRecyclerView2(@NonNull Context context) {
        super(context);
        init(context);
    }

    public VideoPlayerRecyclerView2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//                        if(once) {
//                            smoothScrollToPosition(playPosition + 2);
//                            once = false;
//                        }
                        Log.d(TAG, "onPlaybackStateChanged: "+playPosition);
...
//        removeVideoView(videoSurfaceView);
    ...
    public void playNewVideo(){
        ...
        videoSurfaceView = getChildAt(0).findViewById(R.id.playerView);
        thumbnail = getChildAt(0).findViewById(R.id.thumbnail);

        videoSurfaceView.setPlayer(videoPlayer);
        thumbnail.setVisibility(INVISIBLE);

        //혹시 나중에 음소거나 이런 거 할 때에 사용.
//        viewHolderParent.setOnClickListener(videoViewClickListener);
        ...
        MediaItem firstItem = MediaItem.fromUri(videos.get(0).getVideo());
        videoPlayer.addMediaItem(firstItem);
        videoPlayer.prepare();
        videoPlayer.setPlayWhenReady(true);
